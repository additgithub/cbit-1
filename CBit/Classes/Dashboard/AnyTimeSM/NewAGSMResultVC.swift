...
class NewAGSMResultVC: UIViewController {
...
extension NewAGSMResultVC: UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if collectionView == collectionitem {
            ...
            cell.lbldraw.text = "Total:\(String(winning_options[indexPath.row]["count"] as? Int ?? 0))"
...
extension NewAGSMResultVC: UITableViewDelegate, UITableViewDataSource {
...
//                                                     getFormate: "yyyy-MM-ddTHH:mm:ss.000Z")
//
...
//extension AGSMResultVC: UNUserNotificationCenterDelegate {
