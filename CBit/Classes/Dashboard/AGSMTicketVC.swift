...
class AGSMTicketVC: UIViewController {
    //MARK: - Properties
...
//        collectionviewtickets.reloadData()
    ...
    private func setDetail() {
        ...
        let gamelevel = dictContestDetail["rows"] as? Int ?? 0
...
extension AGSMTicketVC: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
...
extension AGSMTicketVC: UITableViewDelegate, UITableViewDataSource {
...
extension AGSMTicketVC: UNUserNotificationCenterDelegate {
